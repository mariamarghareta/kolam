        ...
        <section class="wrapper site-min-height">
            <div class="col-md-12 white-bg margin-up-md">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link nav material-icons md-11 fa fa-angle-double-left" href="#"></a></li>
                            <li class="page-item"><a class="page-link nav material-icons md-11 fa fa-angle-left" href="#"></a></li>
                            <?php
                                for ($i=0; $i<= $page_count; $i++){
                                    if($i < $max_data/$data_per_page){
                                        $page_num = $i + 1;
                                        if($i == 0){
                                            echo "<li class='page-item page active' index=$i><a class='page-link page' href=''#'>$page_num</a></li>";
                                        }else{
                                            echo "<li class='page-item page' index=$i><a class='page-link page' href=''#'>$page_num</a></li>";
                                        }
                                    }
                                }
                            ?>
                            <li class="page-item"><a class="page-link nav material-icons md-11 fa fa-angle-right" href="#"></a></li>
                            <li class="page-item"><a class="page-link nav material-icons md-11 fa fa-angle-double-right" href="#"></a></li>
                        </ul>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".slhide").hide();
        $(".slshow").show();
        $("label[for='select_data_count']").html('Data per halaman');
    });
