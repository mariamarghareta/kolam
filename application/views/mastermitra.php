...
<head>
    ...
    <title>Master Mitra Bisnis</title>
        ...
        <section class="wrapper site-min-height">
            <div class="col-md-12 white-bg margin-up-md">
                <div class="margin-up-md">
                    <div class="col-sm-8 page-title">Master Mitra Bisnis</div>
                    <div class="col-sm-4 right-align"><a href="<?php echo base_url() . index_page(); ?>/Mastermitra/create" class="btn btn-success btn-sm"><i class="fa fa-plus"></i><span> TAMBAH DATA</span></a></div>
                </div>
                <div id="toolbar">
                ...
                <input type="hidden" value="<?php echo base_url() . index_page(); ?>/Mastermitra" name="route" id="route"/>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row) {
        return [
            '<a href="<?php echo base_url() . index_page(); ?>/Mastermitra/show/' + row['id'] + '" class="btn btn-default waves-effect">Lihat</a>',
            '<a href="<?php echo base_url() . index_page(); ?>/Mastermitra/update/' + row['id'] + '" class="btn btn-default waves-effect">Ubah</a>',
            '<a href="<?php echo base_url() . index_page(); ?>/Mastermitra/delete/' + row['id'] + '" class="btn btn-danger waves-effect">Hapus</a>',
        ].join('');
    }

    function jenisMitraFormatter(value, row){
        if (value == 'C'){
            return "Customer";
        } else {
            return "Supplier"
