        ...
        <section class="wrapper site-min-height">
            <div class="col-md-12 white-bg margin-up-md">
                <div class="margin-up-md">
                    <div class="col-sm-8 page-title">Master Jenis Ikan</div>
                    <div class="col-sm-4 right-align"><a href="<?php echo base_url() . index_page(); ?>/Masterikan/create" class="btn btn-success btn-sm"><i class="fa fa-plus"></i><span> TAMBAH DATA</span></a></div>
                </div>
                <div id="toolbar">
                ...
                <input type="hidden" value="<?php echo base_url() . index_page(); ?>/Masterikan" name="route" id="route"/>
...
<script type="text/javascript">
    ...
    function actionFormatter(value, row) {
        return [
            '<a href="<?php echo base_url() . index_page(); ?>/Masterikan/show/' + row['id'] + '" class="btn btn-default waves-effect">Lihat</a>',
            '<a href="<?php echo base_url() . index_page(); ?>/Masterikan/update/' + row['id'] + '" class="btn btn-default waves-effect">Ubah</a>',
            '<a href="<?php echo base_url() . index_page(); ?>/Masterikan/delete/' + row['id'] + '" class="btn btn-danger waves-effect">Hapus</a>',
        ].join('');
    }
</script>
