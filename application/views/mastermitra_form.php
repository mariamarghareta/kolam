    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            <div class="col-md-8 col-md-offset-2 margin-up-md">
                ...
                if ($state == "update"){
                    echo form_open('Mastermitra/update_data', $attributes);
                } else if ($state == "create"){
                    echo form_open('Mastermitra/add_new_data', $attributes);
                } else if ($state == "delete"){
                    echo form_open('Mastermitra/delete_data', $attributes);
                }
                ?>
                ...
                <div class="w3-container w3-white w3-padding-32">
                    ...
                    <div class="row" style=";">
                        <div class="col-sm-6" style="padding: 0px 30px;">
                            ...
                            <?php echo form_input(array('name'=>'phone1', 'id'=>'phone1', 'class'=>'w3-input'), $phone1);?>
                            <?php echo form_error('phone1'); ?>
                            <br>
                            <label>No. Telepon 2</label>
                            <?php echo form_input(array('name'=>'phone2', 'id'=>'phone2', 'class'=>'w3-input'), $phone2);?>
                        ...
                        <div class="col-sm-6" style="padding: 0px 30px;">
                            ...
                            <div style="margin-top:10px;">
                                <?php
                                if($tipe_mitra == 'S'){
                                    $c=array('id'=>'cust','name'=>'tipe_mitra', 'value'=>'C');
                                    $s=array('id'=>'seller','name'=>'tipe_mitra', 'value'=>'S','checked'=>'checked');
                                } else{
                                    $c=array('id'=>'cust','name'=>'tipe_mitra', 'value'=>'C', 'checked'=>'checked');
                                    $s=array('id'=>'seller','name'=>'tipe_mitra', 'value'=>'S');
                                }
