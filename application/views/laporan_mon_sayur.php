...
<head>
    ...
    <title>Laporan Monitoring Sayur</title>
    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            <div class="col-md-4 col-md-offset-4 white-bg margin-up-md" style="padding:20px 50px;">
                ...
                echo form_open('Laporanmonsayur/search', $attributes);
                ?>
                <div class="margin-up-md row">
                    <div class="col-sm-8 page-title">Laporan Monitoring Sayur</div>
                </div>
                <br>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#menu_laporan_mon_sayur").addClass('active');
