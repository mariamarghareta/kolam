        ...
        <section class="wrapper site-min-height">
            <div class="col-md-12 white-bg margin-up-md">
                <div class="margin-up-md">
                    <div class="col-sm-8 page-title">Monitoring Air</div>
                    <div class="col-sm-4 right-align"><a href="<?php echo base_url() . index_page(); ?>/Monitoringair/create" class="btn btn-success btn-sm"><i class="fa fa-plus"></i><span> TAMBAH DATA</span></a></div>
                </div>
                <div id="toolbar">
                ...
                <table
                    ...
                    <tr>
                        ...
                        <th data-field="kode" data-sortable="true">Kode Tebar Bibit</th)>
                        ...
                        <th data-field="tinggi_air" data-sortable="true">Tinggi Air</th>
                        <th data-field="ph" data-sortable="true">PH</th>
                        <th data-field="suhu" data-sortable="true">Suhu</th>
                        <th data-field="kcr" data-sortable="true">KCR</th>
                        <th data-field="warna" data-sortable="true">Warna</th>
                ...
                <input type="hidden" value="<?php echo base_url() . index_page(); ?>/Monitoringair" name="route" id="route"/>
