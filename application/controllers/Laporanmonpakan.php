...
class Laporanmonpakan extends CI_Controller {
    public function __construct()
    {
        ...
        $this->load->model('Laporan_mon_pakan');
    }
    private $data;
    ...
    public function index()
    {
        $this->check_role();
        $this->initialization();
        $this->load->view('laporan_mon_pakan', $this->data);
    }
    ...
    public function search(){
        ...
        {
            $this->data['detail'] = $this->Laporan_mon_pakan->show_all($this->data['date_from'], $this->data['date_to']);
        }
        $this->data["state"] = "create";
        $this->load->view('laporan_mon_pakan_pdf', $this->data);
    }
}
