...
class Mastergrading extends CI_Controller {
    ...
    public function initialization()
    {
        ...
        $this->data["arr_blok_tujuan"] = ($this->Blok->show_blok_available());
            ...
            if($result) {
                ...
                if(isset($_SESSION['list_grading'])) {
                    ...
                    for ($i = 0; $i < sizeof($temp); $i++) {
                        ...
                        $pemberian_pakan_id = $this->Pemberian_pakan->insert($temp[$i]["ukuran"], $temp[$i]["fr"], $temp[$i]["sr"], $temp[$i]['dosis_pakan'], $temp[$i]['total_pakan'], $temp[$i]['pagi'],
