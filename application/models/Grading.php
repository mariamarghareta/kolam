...
class Grading extends CI_Model
{
    ...
    public function get($id){
        $query = $this->db->select('g.id, g.tebar_id, g.sampling_id, g.asal_kolam_id, g.dt, g.total_biomass, g.total_populasi, g.sr, g.pertumbuhan_daging, g.fcr, g.adg, t.kode, k.name as kolam_name, b.name as blok_name, b.id as blok_id, kar.name as create_user, karw.name as write_user, g.create_time, g.write_time')
            ->from('grading g')
